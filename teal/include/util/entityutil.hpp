...
inline Nz::Vector2f getGraphicsOffset(const Ndk::EntityHandle& e); // Graphics Offset in-map. Animations may have different offset than default character offset
